...
INNER JOIN website_sessions
  ...
  AND utm_source = 'gsearch' -- just for limitation
  AND utm_campaign = 'nonbrand' -- just for limitation
...
GROUP BY 1,2
HAVING COUNT(website_pageviews.website_pageview_id) = '1'; -- for identify bounces
